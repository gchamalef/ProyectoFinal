...
public class sr_cliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //boton agregar
            cliente = new Cliente(Integer.parseInt(request.getParameter("txt_id")), Integer.parseInt(request.getParameter("gender")), request.getParameter("txt_nombres"), request.getParameter("txt_apellidos"), request.getParameter("txt_nit"), request.getParameter("txt_telefono"), request.getParameter("txt_correo"), request.getParameter("fecha_factura"));
