<%-- 
    Document   : usuarios
    Created on : 4 nov 2023, 07:01:21
    Author     : pc01
--%>
    ...
    <head>
        ...
        <style>
            ...
            thead {
                ...
                border-bottom: solid 5px #4E4E4D;
                color: white;
                text-align: center;
                border-radius: 6px;
            }
                        ...
                        for (int t = 0; t < tabla.getRowCount(); t++) {
                            ...
                            for (int l = 2; l < 11; l++) {
                                if (tabla.getValueAt(t, l).equals("1")) {
                                    out.println("<td ><input type='checkbox' checked disabled class='styled-checkbox'></td>");
                                } else {
                                    out.println("<td ><input type='checkbox'  disabled class='styled-checkbox'></td>");
                                }
                            }
