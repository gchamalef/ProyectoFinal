<%-- 
    Document   : puestos
    Created on : 3 nov 2023, 00:00:45
    Author     : pc01
--%>
    ...
    <body>
        ...
        <div class="container">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <form action="sr_puesto" method="post"class="form-group" >
                                ...
                                <input type="submit" class="btn btn-warning" name="btn_eliminar" id="btn_eliminar" value="Eliminar"onclick="javascript:if (!confirm('¿Desea Eliminar?'))
                    return false">
            ...
            <div id="main-container">
                ...
                <button type="button" name="btn_nuevo" id="btn_nuevo"  data-toggle="modal" data-target="#modal_puestos" onclick="limpiar()">Nuevo</button>        
            </div>
        </div>
